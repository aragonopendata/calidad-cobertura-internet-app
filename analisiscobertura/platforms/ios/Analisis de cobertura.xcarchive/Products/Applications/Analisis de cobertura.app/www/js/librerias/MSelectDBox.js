		...
		MSelectDBox.prototype = {
			...
			"_initStyles": function(){
				...
				if ( !$('#mSelectDBoxStyle').length ){
					var stylecss = ''
						+' .MSelectDBox																									{position:absolute; display:block; width:calc(100% - 2.6rem) !important; left: 0.8rem !important; padding:'+this.styles.dboxPaddings+'px; height:auto; box-shadow:0px 0px 8px rgba(0, 0, 0, 0.24); background-color: #FFF; border-radius: 3px;}'
						+' .MSelectDBox_hidden																						{display:none;}'
						+' .MSelectDBox:before																							{content:\'\'; position:absolute; border-left:10px solid transparent; border-right:9px solid transparent; border-bottom:10px solid black; top: -11px; left: 50%; margin-left: -10px;}'	
						...
						+' .MSelectDBox_bottom:before																				{content:\'\'; position:absolute; border-left:10px solid transparent; border-right:9px solid transparent; border-bottom: none; border-top:10px solid black; top: initial; bottom: -11px; left: 50%; margin-left: -10px;}'
						...
						+' .MSelectDBox__list-item																					{position:relative; padding:0.5rem; color:black; display:block; line-height:100%; cursor:pointer; font-size: 1rem;}'
						+' .MSelectDBox__list-item:hover, .MSelectDBox__list-item_hover 								{background-color:#e6e6e6;}'
						+' .MSelectDBox__list-item_selected																		{background-color:#FFCA00; color:black;}'
						+' .MSelectDBox__list-item_selected:hover, .MSelectDBox__list-item_selected.MSelectDBox__list-item_hover	{background-color:#FFCA00;}'
						+' .MSelectDBox__list-item_selected:before																{content:\':: \';}'
						+' .MSelectDBox__list-item:active, .MSelectDBox__list-item_selected:active					{background-color:#FDF1CD; color:black;}'
